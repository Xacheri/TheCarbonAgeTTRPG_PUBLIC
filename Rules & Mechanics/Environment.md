The environment that one adventures in has a major impact on the dangers posed and the skills required to survive. The types of environmental factors discussed here are: *Climate*, *Weather*, and *Hazards*.
## Climate
The refers to the temperature of the region and any ever-present *Weather* effects that are posed on the region.
### Heat
When the temperature is uncomfortable hot, players consume twice the regularly required amount of water per day
### Extreme Heat
...
### Cold
When the temperature is below 32 degrees Fahrenheit, and your character is unequipped for the cold weather, your travel speed is reduced by half over map-scale distances. 
### Extreme Cold
...
### Heavy Precipitation
Everything within an area of heavy precipitation is lightly obscured, and creatures in the area have disadvantage on Wisdom (Perception) checks that rely on sight.

Heavy rain also extinguishes open flames and imposes disadvantage on Wisdom (Perception) checks that rely on hearing.
## Hazards